    ...
    extends DefaultCellEditor
{
  ...
  public MoneyCellEditor()
  {
    ...
    text.setFormatterFactory(new DefaultFormatterFactory(new NumberFormatter(new DecimalFormat("##.##"))));
  ...
  {
    Object[] msg = {"编辑", "取消"};
    int choose = JOptionPane.showOptionDialog(SwingUtilities.getWindowAncestor(text), "金额不正确！\n是否继续编辑金额？", "错误",
        JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE, null, msg, msg[1]);
    if (choose == 1)
    {
