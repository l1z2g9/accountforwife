...
public class CategoryPane extends JDialog {
	...
	public CategoryPane(Window frame, final String type) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (cate.equalsIgnoreCase("")) {
					JOptionPane.showMessageDialog(SwingUtilities
							.getWindowAncestor(CategoryPane.this), "不能添加空白数据!",
							"添加错误", JOptionPane.ERROR_MESSAGE);
					return;
				}
		...
		close.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CategoryPane.this.setVisible(false);
				CategoryPane.this.dispose();
			}
		});
		leftPanel.add(close);
